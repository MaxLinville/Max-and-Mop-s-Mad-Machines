...
import net.mooplemax.madmachines.block.entity.SuperFurnaceBlockEntity;
...
public class SuperFurnaceBlock extends AbstractFurnaceBlock {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(world, type, ModBlockEntities.SUPER_FURNACE);
    }

    protected void openScreen(World world, BlockPos pos, PlayerEntity player) {
        BlockEntity blockEntity = world.getBlockEntity(pos);
        if (blockEntity instanceof SuperFurnaceBlockEntity) {
