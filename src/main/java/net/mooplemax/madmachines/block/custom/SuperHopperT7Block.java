...
import net.mooplemax.madmachines.block.entity.SuperHopperT7BlockEntity;
...
public class SuperHopperT7Block
    ...
    public SuperHopperT7Block(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new SuperHopperT7BlockEntity(pos, state);
    }

    @Override
    @Nullable
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : SuperHopperT3Block.checkType(type, ModBlockEntities.SUPER_HOPPER_T7, SuperHopperT7BlockEntity::serverTick);
    }

    @Override
    public void onPlaced(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack itemStack) {
        BlockEntity blockEntity;
        if (itemStack.hasCustomName() && (blockEntity = world.getBlockEntity(pos)) instanceof SuperHopperT7BlockEntity) {
            ((SuperHopperT7BlockEntity)blockEntity).setCustomName(itemStack.getName());
        }
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (blockEntity instanceof SuperHopperT7BlockEntity) {
            player.openHandledScreen((SuperHopperT7BlockEntity)blockEntity);
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        ...
        BlockEntity blockEntity = world.getBlockEntity(pos);
        if (blockEntity instanceof SuperHopperT7BlockEntity) {
            ItemScatterer.spawn(world, pos, (Inventory)((SuperHopperT7BlockEntity)blockEntity));
    ...
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        BlockEntity blockEntity = world.getBlockEntity(pos);
        if (blockEntity instanceof SuperHopperT7BlockEntity) {
            SuperHopperT7BlockEntity.onEntityCollided(world, pos, state, entity, (SuperHopperT7BlockEntity)blockEntity);
        }
    }
